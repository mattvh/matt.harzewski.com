 ...
 * @param {boolean} Linkify URLs
 * @param {boolean} Show user photo and name
 * @param {boolean} Show timestamp
 * @param {function/string} Date formatter callback
 */
twitterFetcher.fetch('335631045737189376', 'sbtweets', 4, true, true, false);